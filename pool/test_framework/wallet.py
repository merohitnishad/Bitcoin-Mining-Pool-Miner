...
class MiniWallet:
    def __init__(
        self, test_node, *, mode=MiniWalletMode.ADDRESS_OP_TRUE, tag_name=None
    ):
        ...
        if mode == MiniWalletMode.RAW_OP_TRUE:
            ...
            self._address, self._internal_key = (
                create_deterministic_address_bcrt1_p2tr_op_true(internal_key)
            )
