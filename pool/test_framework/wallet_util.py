...
from test_framework.messages import WITNESS_SCALE_FACTOR, CTxIn, CTxInWitness
...
class TestFrameworkWalletUtil(unittest.TestCase):
    def test_calculate_input_weight(self):
        ...
        SMALL_LEN_BYTES = (
            1  # bytes needed for encoding scriptSig / witness item lengths < 253
        )
        LARGE_LEN_BYTES = (
            3  # bytes needed for encoding scriptSig / witness item lengths >= 253
        )
